...
```{r}
# Create an affected/unaffected column in a copy of buildings
...
#| warning: false
#| message: false
affected_homes_map <- tm_basemap("OpenStreetMap") +
...
affected_homes_map <- tm_shape(buildings_status) +
   tm_polygons(alpha = "Status",
            alpha.palette = c("Affected" = 1, "Not Affected" = 0.2),
            col = "Status",
            palette = c("Affected" = "red", "Not Affected" = "grey80")) + 
