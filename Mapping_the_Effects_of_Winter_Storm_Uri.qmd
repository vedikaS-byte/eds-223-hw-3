...
![](images/clipboard-540590989.png)
...
buildings_affected_blackout <- st_filter(buildings, blackout_not_highway, 
                                         .predicate = st_intersects) %>% st_centroid() # Convert polygons to center points
...
```{r}
# Filter for buildings not in affected buildings
...
affected_homes_map <- tm_basemap("OpenStreetMap") + # Basemap
  ...
  # AFFECTED homes (strong emphasis)
  tm_shape(buildings_affected_blackout) +
  tm_dots(
    col = "#B30000",              # Bright red
    size = 0.05,              # Larger dots
