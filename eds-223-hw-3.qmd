...
#| warning: false
#| message: false
# Create map for homes affected by the blackout
...
acs_affected <- st_filter(socioeconomic, buildings_affected_blackout, 
                          .predicate = st_intersects)
```
...
tm_polygons(
  ...
  tm_layout(
    main.title = "Blackout Impact by Income in Houston Census Tracts (Feb 2021)",
    main.title.size = 2,
...
##### summary table using kable extra for median, mean, sd of census tracts impacted vs not impacted
